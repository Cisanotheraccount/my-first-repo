...
- The autoplay button loops from 2016 to 2026 in 30 seconds. During playback, hex heights interpolate between adjacent months with a smooth easing curve; users can still drag the timeline manually.
